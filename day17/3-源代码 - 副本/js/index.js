 ...
 * @Last Modified time: 2017-10-07 17:35:41
 */
$(function() {
    ...
    function section8Animate() {
        ...
        // $('.section8-begin').on('hover', function() {
        //     $(this).children().eq(1).toggle();
        // });
        $(document).on('mousemove', function(e) {
            var x = e.pageX + 20;
            var y = e.pageY;
            var minY = windowHeight - $('.section8-hand').height();
            if (y < minY) {
                y = minY;
            }
            $('.section8-hand').css({ 'left': x, "top": y });
        });
        $('.section8-again').on('click', function() {
            //1. 要返回第一屏
            $('.section > .fp-tableCell div').attr('style', '');
            flag = false;
            flag1 = false;
